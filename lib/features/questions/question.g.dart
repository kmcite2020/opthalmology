...
Question deserializeQuestion(IsarReader reader) {
  ...
  final String? _a;
  _a = IsarCore.readString(reader, 2);
  final String? _b;
  _b = IsarCore.readString(reader, 3);
  final String? _c;
  _c = IsarCore.readString(reader, 4);
  final String? _d;
  _d = IsarCore.readString(reader, 5);
...
class _QuestionUpdateImpl implements _QuestionUpdate {
  ...
  bool call({
    ...
    return collection.updateProperties([
          ...
          if (a != ignore) 2: a as String?,
          if (b != ignore) 3: b as String?,
          if (c != ignore) 4: c as String?,
          if (d != ignore) 5: d as String?,
        }) >
        0;
  }
}
...
const QuestionSchema = IsarGeneratedSchema(
  ...
  converter: IsarObjectConverter<void, Question>(
    serialize: serializeQuestion,
    deserialize: deserializeQuestion,
  ),
);
